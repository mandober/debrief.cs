...
- [Network types](network-types-in-general.md)
- [Network types by spatial scope](./networks-by-spatial-scope.md)
- [Network theory](./network-theory.md)
- [Computer network](./computer-network.md)
- [Subnetwork](./subnetwork.md)

- [Internetworking](./internetworking.md)
...
- [IPv4](./ipv4.md)
- [IPv6](./ipv6.md)
- [Classless Inter-Domain Routing](./classless-inter-domain-routing.md)
